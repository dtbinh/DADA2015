...
\subsubsection{Procedural character animation}

\subsubsection{Data-driven character animation}

\subsubsection{Non-player characters (NPC)}
...
Budget: We request a financial aid of 500 K\euro for 3 PhD students (360 K\euro), 1 post-doc at Paris 8 (60 K\euro), computer hardware and software (20 k\euro), travel expenses (60 K\euro). The project duration should be 42 months in order to develop a functional prototype and to use it to animate several play scripts.
...
Paris 8  will hire a post-doc for the final 18 months  of the project to perform user studies 
testing the quality of the generated animations and usability of the DADA prototype.

LIF will hire a PhD student for 36 months

Inria will hire a PhD students for 36 months

LITC will  hire a Phd student for 36 months
...
We plan to take part in the relevant international conferences, including "intelligent virtual agents",
Siggraph and Siggraph Asia, Eurographics, 
